/**
 * LOTTEON Google Sheets Apps Script GitHub Remote Loader v1.14-MAIN
 *
 * v1.14 핵심:
 * - v1.13 PR smoke loader 구조와 ScriptApp continuation bridge 유지
 * - Code.gs와 patch bootstrap을 GitHub main branch에서 직접 로드
 * - bootstrap 내부 main base URL을 그대로 사용
 * - 캐시 없이 매 실행 최신 main 코드를 로드
 *
 * 사용 방법:
...
const LOTTEON_MAIN_RAW_BASE = 'https://raw.githubusercontent.com/beliun1001-art/lotteon-gus-script/main/';
const LOTTEON_GITHUB_CODE_URL = LOTTEON_MAIN_RAW_BASE + 'Code.gs';
const LOTTEON_GITHUB_PATCH_URL = LOTTEON_MAIN_RAW_BASE + 'Patch_v6_24_bootstrap_auto_continue.gs';
const LOTTEON_FILTER_COUNT_LIGHTWEIGHT_URL = LOTTEON_MAIN_RAW_BASE + 'FilterCountLightweight_v6_56.gs';
const LOTTEON_LOADER_VERSION = 'v1.14-MAIN';
...
function testLotteonGitHubConnection() {
  ...
  SpreadsheetApp.getUi().alert(
    ...
    'Main Base: ' + LOTTEON_MAIN_RAW_BASE + '\n' +
...
function continueBrandLifecycleDashboard_v659_() { return runRemoteFunctionByName_('continueBrandLifecycleDashboard_v659_'); }
